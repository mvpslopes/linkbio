...
# Subdomínios
$subdomains = @("paty", "marcosblea", "equusvita", "racaemarcha", "cristianoladeira", "puramarcha", "fafs", "topmarchador", "alinesantana", "orielsilvano", "jessicapersonal", "emmanueladv", "maludias", "lancamento", "willianpersonal", "nutrisheiladomingues", "aliancce", "masteragro", "haraspariz", "giuliadias", "ruanabatistapersonal", "criar")
