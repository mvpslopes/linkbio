 ...
 *   <script src="https://linkbio.api.br/tracker.js" data-slug="paty"></script>
 */
(function () {
  var script = document.currentScript;
  var base   = script && script.src ? script.src.replace(/\/tracker\.js.*$/i, '') : 'https://linkbio.api.br';
  var API    = base + '/admin/api/track.php';
